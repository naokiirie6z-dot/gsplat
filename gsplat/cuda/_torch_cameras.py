...
class _BaseCameraModel(ABC):
    ...
    def create(
        ...
        if camera_model == "pinhole":
            ...
            # given: some callers derive and pass focal_lengths from Ks for
            # every camera model, so equirectangular must silently ignore it
            # (it has no real focal length) rather than error out.
            ...
            raise ValueError(
                ...
                f"Supported: pinhole, ortho, fisheye, ftheta, lidar, equirectangular"
            )
